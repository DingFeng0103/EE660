...
public:
	...
	void AdaptiveHuffmanEncoding(string sourcefilename,string destinationfilename);
	void AdaptiveHuffmanDecoding(string sourcefilename, string destinationfilename);
